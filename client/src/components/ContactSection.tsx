          ...
          <div className="grid md:grid-cols-2">
            <div className="p-8 lg:p-12">
              <div className="mb-8">
                ...
                <h3 className="text-2xl font-bold text-primary-900 mb-4">Ready for a Simpler Solution?</h3>
                <p className="text-primary-600">
                  Tell us about your needs and we'll schedule a free consultation to see if we're a good fit.
                </p>
              </div>
            ...
            <div className="bg-[#0f172a] p-8 lg:p-12 text-white flex flex-col justify-between">
              ...
              <div className="mt-8 pt-8 border-t border-[#334155]">
                ...
                <div className="flex items-center mb-3">
                  ...
                  <a href="mailto:hello@stupidsimpleapps.com" className="text-[#7dd3fc] hover:text-[#bae6fd] transition">hello@stupidsimpleapps.com</a>
                </div>
                <div className="flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#38bdf8] mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
                  <a href="tel:+15551234567" className="text-[#7dd3fc] hover:text-[#bae6fd] transition">(555) 123-4567</a>
                </div>
              </div>
            </div>
          </div>
