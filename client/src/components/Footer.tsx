        ...
        <div className="grid md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <Link href="/" className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold text-white">Stupid Simple Apps</span>
            </Link>
            <p className="mb-4 max-w-md">
              We build simple, tailored applications that solve your exact problems without the bloat. Flat fee, no per-user costs.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="text-primary-400 hover:text-white transition">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center">
                ...
                <a href="mailto:hello@stupidsimpleapps.com" className="hover:text-white transition">hello@stupidsimpleapps.com</a>
              </li>
              <li className="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-primary-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
