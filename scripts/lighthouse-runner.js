...
class LighthouseRunner {
  ...
  async buildProject() {
    ...
    if (this.useMockData) {
      console.log('  ℹ️ Skipping build in mock mode');
      return;
    }
  ...
  async startServer() {
    ...
    if (this.useMockData) {
      console.log('  ℹ️ Skipping server start in mock mode');
      return;
    }
  ...
  async generateReports() {
    ...
    console.log(`  ✅ Baseline report saved as lighthouse-baseline.json`);
  }
...
<body>
  <div class="container">
    ...
    // Also save as lighthouse-baseline.html
    fs.writeFileSync('lighthouse-baseline.html', html);
  }
